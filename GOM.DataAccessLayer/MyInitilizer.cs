...
{
    class MyInitilizer : CreateDatabaseIfNotExists<DatabaseContext>    //bi tane database context classı oluştuğunda myinitalizaer de alt clası olduuğu için çalışıyı
    {
